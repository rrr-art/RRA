# chat/views.py (The view that serves the HTML)

from django.shortcuts import render

def index(request):
    # This renders the index.html file we created
    return render(request, 'chat/index.html')from django.urls import path, include
# ...
urlpatterns = [
